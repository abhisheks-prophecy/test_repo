...
class Reformat_3Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_3/in/schema.json",
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_3/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_3/out/schema.json",
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_3/out/data/unit_test_0.json",
      "out"
    )
