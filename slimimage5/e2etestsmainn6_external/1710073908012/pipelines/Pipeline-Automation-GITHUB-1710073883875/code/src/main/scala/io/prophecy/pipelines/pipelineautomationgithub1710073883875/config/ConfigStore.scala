package io.prophecy.pipelines.pipelineautomationgithub1710073883875.config

import io.prophecy.pipelines.pipelineautomationgithub1710073883875.config.Context
