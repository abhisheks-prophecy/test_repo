package io.prophecy.pipelines.workflowautomationgithub1720001592951.config

import io.prophecy.pipelines.workflowautomationgithub1720001592951.config.Context
