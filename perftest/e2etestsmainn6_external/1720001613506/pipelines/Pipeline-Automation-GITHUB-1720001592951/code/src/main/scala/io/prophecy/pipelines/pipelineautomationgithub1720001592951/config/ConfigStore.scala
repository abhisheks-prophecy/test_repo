package io.prophecy.pipelines.pipelineautomationgithub1720001592951.config

import io.prophecy.pipelines.pipelineautomationgithub1720001592951.config.Context
