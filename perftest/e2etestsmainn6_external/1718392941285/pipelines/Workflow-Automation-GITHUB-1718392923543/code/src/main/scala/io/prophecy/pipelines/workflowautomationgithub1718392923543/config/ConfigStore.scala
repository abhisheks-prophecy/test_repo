package io.prophecy.pipelines.workflowautomationgithub1718392923543.config

import io.prophecy.pipelines.workflowautomationgithub1718392923543.config.Context
