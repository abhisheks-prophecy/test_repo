package io.prophecy.pipelines.workflowautomationgithub1708712938298.config

import io.prophecy.pipelines.workflowautomationgithub1708712938298.config.Context
