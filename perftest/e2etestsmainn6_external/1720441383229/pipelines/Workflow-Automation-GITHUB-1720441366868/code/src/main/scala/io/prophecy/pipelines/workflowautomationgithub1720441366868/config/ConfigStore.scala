package io.prophecy.pipelines.workflowautomationgithub1720441366868.config

import io.prophecy.pipelines.workflowautomationgithub1720441366868.config.Context
