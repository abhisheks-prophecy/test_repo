package io.prophecy.pipelines.pipelineautomationgithub1716485650774.config

import io.prophecy.pipelines.pipelineautomationgithub1716485650774.config.Context
