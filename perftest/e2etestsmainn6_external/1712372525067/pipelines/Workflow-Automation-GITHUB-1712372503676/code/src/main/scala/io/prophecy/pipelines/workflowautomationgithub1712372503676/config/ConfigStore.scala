package io.prophecy.pipelines.workflowautomationgithub1712372503676.config

import io.prophecy.pipelines.workflowautomationgithub1712372503676.config.Context
