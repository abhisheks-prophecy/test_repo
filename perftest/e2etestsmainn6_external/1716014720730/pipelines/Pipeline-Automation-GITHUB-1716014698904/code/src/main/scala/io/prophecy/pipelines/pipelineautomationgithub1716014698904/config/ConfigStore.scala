package io.prophecy.pipelines.pipelineautomationgithub1716014698904.config

import io.prophecy.pipelines.pipelineautomationgithub1716014698904.config.Context
