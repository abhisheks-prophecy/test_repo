package io.prophecy.pipelines.workflowautomationgithub1719857117887.config

import io.prophecy.pipelines.workflowautomationgithub1719857117887.config.Context
