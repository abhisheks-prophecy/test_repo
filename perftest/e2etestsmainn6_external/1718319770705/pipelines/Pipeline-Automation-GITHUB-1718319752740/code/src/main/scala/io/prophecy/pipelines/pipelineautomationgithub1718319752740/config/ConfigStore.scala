package io.prophecy.pipelines.pipelineautomationgithub1718319752740.config

import io.prophecy.pipelines.pipelineautomationgithub1718319752740.config.Context
