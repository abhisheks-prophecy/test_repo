package io.prophecy.pipelines.workflowautomationgithub1721808094266.config

import io.prophecy.pipelines.workflowautomationgithub1721808094266.config.Context
