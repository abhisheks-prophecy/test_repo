package io.prophecy.pipelines.workflowautomationgithub1720545637659.config

import io.prophecy.pipelines.workflowautomationgithub1720545637659.config.Context
