package io.prophecy.pipelines.pipelineautomationgithub1710156875430.config

import io.prophecy.pipelines.pipelineautomationgithub1710156875430.config.Context
