package io.prophecy.pipelines.workflowautomationgithub1705546526741.config

import io.prophecy.pipelines.workflowautomationgithub1705546526741.config.Context
