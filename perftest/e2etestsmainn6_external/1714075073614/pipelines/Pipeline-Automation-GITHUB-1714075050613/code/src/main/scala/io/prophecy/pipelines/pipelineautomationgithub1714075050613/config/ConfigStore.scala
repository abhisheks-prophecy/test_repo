package io.prophecy.pipelines.pipelineautomationgithub1714075050613.config

import io.prophecy.pipelines.pipelineautomationgithub1714075050613.config.Context
