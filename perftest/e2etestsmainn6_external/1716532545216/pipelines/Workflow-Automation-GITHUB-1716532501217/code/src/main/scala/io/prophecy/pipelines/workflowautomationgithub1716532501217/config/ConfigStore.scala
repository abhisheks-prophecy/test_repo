package io.prophecy.pipelines.workflowautomationgithub1716532501217.config

import io.prophecy.pipelines.workflowautomationgithub1716532501217.config.Context
