package io.prophecy.pipelines.pipelineautomationgithub1718559290025.config

import io.prophecy.pipelines.pipelineautomationgithub1718559290025.config.Context
