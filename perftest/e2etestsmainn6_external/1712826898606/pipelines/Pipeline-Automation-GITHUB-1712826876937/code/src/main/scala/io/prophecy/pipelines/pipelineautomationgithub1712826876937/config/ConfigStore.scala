package io.prophecy.pipelines.pipelineautomationgithub1712826876937.config

import io.prophecy.pipelines.pipelineautomationgithub1712826876937.config.Context
