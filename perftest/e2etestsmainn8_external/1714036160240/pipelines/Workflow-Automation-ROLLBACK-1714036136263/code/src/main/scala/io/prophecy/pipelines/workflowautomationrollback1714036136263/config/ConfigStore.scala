package io.prophecy.pipelines.workflowautomationrollback1714036136263.config

import io.prophecy.pipelines.workflowautomationrollback1714036136263.config.Context
