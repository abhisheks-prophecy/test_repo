package io.prophecy.pipelines.workflowautomationrollback1718629446676.config

import io.prophecy.pipelines.workflowautomationrollback1718629446676.config.Context
