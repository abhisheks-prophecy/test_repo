package io.prophecy.pipelines.workflowautomationgithub1738811313939.config

import io.prophecy.pipelines.workflowautomationgithub1738811313939.config.Context
