package io.prophecy.pipelines.workflowautomationgithub1736997400361.config

import io.prophecy.pipelines.workflowautomationgithub1736997400361.config.Context
