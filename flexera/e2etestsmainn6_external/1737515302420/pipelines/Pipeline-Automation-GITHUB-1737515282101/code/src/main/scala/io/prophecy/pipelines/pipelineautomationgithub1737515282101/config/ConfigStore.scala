package io.prophecy.pipelines.pipelineautomationgithub1737515282101.config

import io.prophecy.pipelines.pipelineautomationgithub1737515282101.config.Context
