package io.prophecy.pipelines.workflowautomationgithub1734313963349.config

import io.prophecy.pipelines.workflowautomationgithub1734313963349.config.Context
