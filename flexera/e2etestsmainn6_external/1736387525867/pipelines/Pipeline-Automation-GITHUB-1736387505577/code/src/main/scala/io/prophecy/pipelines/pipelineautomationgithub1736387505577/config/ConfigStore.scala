package io.prophecy.pipelines.pipelineautomationgithub1736387505577.config

import io.prophecy.pipelines.pipelineautomationgithub1736387505577.config.Context
