package io.prophecy.pipelines.workflowautomationgithub1733450074970.config

import io.prophecy.pipelines.workflowautomationgithub1733450074970.config.Context
