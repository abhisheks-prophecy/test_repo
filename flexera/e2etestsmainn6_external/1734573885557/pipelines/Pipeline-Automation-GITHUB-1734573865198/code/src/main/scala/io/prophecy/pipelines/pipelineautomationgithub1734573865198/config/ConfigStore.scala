package io.prophecy.pipelines.pipelineautomationgithub1734573865198.config

import io.prophecy.pipelines.pipelineautomationgithub1734573865198.config.Context
