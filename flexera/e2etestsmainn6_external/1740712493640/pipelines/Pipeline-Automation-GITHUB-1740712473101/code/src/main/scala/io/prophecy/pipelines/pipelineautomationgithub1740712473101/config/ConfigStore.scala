package io.prophecy.pipelines.pipelineautomationgithub1740712473101.config

import io.prophecy.pipelines.pipelineautomationgithub1740712473101.config.Context
