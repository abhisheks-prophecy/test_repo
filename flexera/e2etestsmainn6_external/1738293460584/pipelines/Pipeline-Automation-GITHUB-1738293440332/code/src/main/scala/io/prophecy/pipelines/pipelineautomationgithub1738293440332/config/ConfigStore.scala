package io.prophecy.pipelines.pipelineautomationgithub1738293440332.config

import io.prophecy.pipelines.pipelineautomationgithub1738293440332.config.Context
