package io.prophecy.pipelines.workflowautomationgithub1739244038487.config

import io.prophecy.pipelines.workflowautomationgithub1739244038487.config.Context
