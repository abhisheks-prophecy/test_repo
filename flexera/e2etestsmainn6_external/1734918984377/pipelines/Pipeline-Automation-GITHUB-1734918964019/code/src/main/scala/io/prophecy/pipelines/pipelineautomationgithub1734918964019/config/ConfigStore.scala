package io.prophecy.pipelines.pipelineautomationgithub1734918964019.config

import io.prophecy.pipelines.pipelineautomationgithub1734918964019.config.Context
