package io.prophecy.pipelines.workflowautomationgithub1740388106371.config

import io.prophecy.pipelines.workflowautomationgithub1740388106371.config.Context
