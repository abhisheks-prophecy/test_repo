...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "10543/pipelines/Automated-Github-UpdateToken-Pipeline")
    MetricsCollector.start(spark = spark, pipelineId = "10543/pipelines/Automated-Github-UpdateToken-Pipeline")
    pipeline(spark)
