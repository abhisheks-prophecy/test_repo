package io.prophecy.pipelines.pipelineautomationgithub1720045934411.config

import io.prophecy.pipelines.pipelineautomationgithub1720045934411.config.Context
