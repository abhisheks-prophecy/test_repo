package io.prophecy.pipelines.workflowautomationgithub1731612062629.config

import io.prophecy.pipelines.workflowautomationgithub1731612062629.config.Context
