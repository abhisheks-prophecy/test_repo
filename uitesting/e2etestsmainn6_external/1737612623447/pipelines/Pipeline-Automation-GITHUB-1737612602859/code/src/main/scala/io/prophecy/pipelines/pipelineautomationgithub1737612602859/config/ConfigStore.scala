package io.prophecy.pipelines.pipelineautomationgithub1737612602859.config

import io.prophecy.pipelines.pipelineautomationgithub1737612602859.config.Context
