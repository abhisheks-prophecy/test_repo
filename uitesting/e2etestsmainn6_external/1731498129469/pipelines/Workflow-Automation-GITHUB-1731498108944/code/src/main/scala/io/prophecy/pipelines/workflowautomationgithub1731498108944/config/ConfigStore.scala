package io.prophecy.pipelines.workflowautomationgithub1731498108944.config

import io.prophecy.pipelines.workflowautomationgithub1731498108944.config.Context
