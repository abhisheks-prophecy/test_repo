package io.prophecy.pipelines.pipelineautomationgithub1740689644810.config

import io.prophecy.pipelines.pipelineautomationgithub1740689644810.config.Context
