package io.prophecy.pipelines.workflowautomationgithub1720588929463.config

import io.prophecy.pipelines.workflowautomationgithub1720588929463.config.Context
