package io.prophecy.pipelines.workflowautomationgithub1740056122037.config

import io.prophecy.pipelines.workflowautomationgithub1740056122037.config.Context
