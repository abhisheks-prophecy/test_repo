package io.prophecy.pipelines.workflowautomationgithub1736838019634.config

import io.prophecy.pipelines.workflowautomationgithub1736838019634.config.Context
