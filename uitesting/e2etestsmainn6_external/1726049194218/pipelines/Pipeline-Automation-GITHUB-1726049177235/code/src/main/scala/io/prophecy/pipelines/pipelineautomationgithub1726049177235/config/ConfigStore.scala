package io.prophecy.pipelines.pipelineautomationgithub1726049177235.config

import io.prophecy.pipelines.pipelineautomationgithub1726049177235.config.Context
