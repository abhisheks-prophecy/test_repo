package io.prophecy.pipelines.pipelineautomationgithub1732037834136.config

import io.prophecy.pipelines.pipelineautomationgithub1732037834136.config.Context
