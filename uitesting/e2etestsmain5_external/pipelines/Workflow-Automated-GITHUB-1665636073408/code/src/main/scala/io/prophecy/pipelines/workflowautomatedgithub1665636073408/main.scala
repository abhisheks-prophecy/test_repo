package io.prophecy.pipelines.workflowautomatedgithub1665636073408

import io.prophecy.libs._
import io.prophecy.pipelines.workflowautomatedgithub1665636073408.config.ConfigStore._
import io.prophecy.pipelines.workflowautomatedgithub1665636073408.config._
...
import io.prophecy.pipelines.workflowautomatedgithub1665636073408.graph._
...
object Main {
  ...
  def apply(spark: SparkSession): Unit = {
    ...
    dataset_out_46736(spark, df_Filter_1)
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/Workflow-Automated-GITHUB-1665636073408"
    )
