package io.prophecy.pipelines.pipelineautomationchetan_release_api_1729668932395

import io.prophecy.libs._
import io.prophecy.pipelines.pipelineautomationchetan_release_api_1729668932395.config._
...
import io.prophecy.pipelines.pipelineautomationchetan_release_api_1729668932395.graph._
...
object Main {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val spark: SparkSession = SparkSession
      .builder()
      .appName("Pipeline-Automationchetan_RELEASE_API_1729668932395")
    ...
    spark.conf.set(
      ...
      "pipelines/Pipeline-Automationchetan_RELEASE_API_1729668932395"
    )
    registerUDFs(spark)
