package io.prophecy.pipelines.workflowautomationgithub1707307897226.config

import io.prophecy.pipelines.workflowautomationgithub1707307897226.config.Context
