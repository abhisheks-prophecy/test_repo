package io.prophecy.pipelines.pipelineautomationgithub1717668221273.config

import io.prophecy.pipelines.pipelineautomationgithub1717668221273.config.Context
