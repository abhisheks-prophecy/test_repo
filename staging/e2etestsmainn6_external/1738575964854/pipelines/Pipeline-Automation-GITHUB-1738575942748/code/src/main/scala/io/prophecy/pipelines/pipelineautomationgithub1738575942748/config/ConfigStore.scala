package io.prophecy.pipelines.pipelineautomationgithub1738575942748.config

import io.prophecy.pipelines.pipelineautomationgithub1738575942748.config.Context
