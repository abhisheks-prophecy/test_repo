package io.prophecy.pipelines.pipelineautomationgithub1738905785983.config

import io.prophecy.pipelines.pipelineautomationgithub1738905785983.config.Context
