package io.prophecy.pipelines.pipelineautomationgithub1735186636558.config

import io.prophecy.pipelines.pipelineautomationgithub1735186636558.config.Context
