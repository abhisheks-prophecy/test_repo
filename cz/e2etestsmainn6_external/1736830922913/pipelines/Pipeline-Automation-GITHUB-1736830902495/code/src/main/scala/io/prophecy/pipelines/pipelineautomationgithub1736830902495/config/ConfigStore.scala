package io.prophecy.pipelines.pipelineautomationgithub1736830902495.config

import io.prophecy.pipelines.pipelineautomationgithub1736830902495.config.Context
