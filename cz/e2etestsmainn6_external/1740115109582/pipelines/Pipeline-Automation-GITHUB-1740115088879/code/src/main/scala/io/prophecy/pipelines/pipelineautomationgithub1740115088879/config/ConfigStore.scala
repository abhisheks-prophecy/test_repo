package io.prophecy.pipelines.pipelineautomationgithub1740115088879.config

import io.prophecy.pipelines.pipelineautomationgithub1740115088879.config.Context
