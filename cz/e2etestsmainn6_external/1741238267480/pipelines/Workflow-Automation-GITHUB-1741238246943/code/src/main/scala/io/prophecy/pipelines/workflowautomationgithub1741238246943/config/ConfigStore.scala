package io.prophecy.pipelines.workflowautomationgithub1741238246943.config

import io.prophecy.pipelines.workflowautomationgithub1741238246943.config.Context
