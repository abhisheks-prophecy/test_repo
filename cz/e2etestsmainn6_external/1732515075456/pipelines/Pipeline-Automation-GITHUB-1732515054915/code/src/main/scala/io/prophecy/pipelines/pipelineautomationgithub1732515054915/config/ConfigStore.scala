package io.prophecy.pipelines.pipelineautomationgithub1732515054915.config

import io.prophecy.pipelines.pipelineautomationgithub1732515054915.config.Context
