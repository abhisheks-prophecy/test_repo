package io.prophecy.pipelines.pipelineautomationgithub1734407530092.config

import io.prophecy.pipelines.pipelineautomationgithub1734407530092.config.Context
