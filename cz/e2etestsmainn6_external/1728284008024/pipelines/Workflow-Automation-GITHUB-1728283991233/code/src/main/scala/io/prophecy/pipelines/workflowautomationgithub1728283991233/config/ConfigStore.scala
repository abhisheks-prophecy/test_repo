package io.prophecy.pipelines.workflowautomationgithub1728283991233.config

import io.prophecy.pipelines.workflowautomationgithub1728283991233.config.Context
