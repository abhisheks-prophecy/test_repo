package io.prophecy.pipelines.pipelineautomationgithub1736832181462.config

import io.prophecy.pipelines.pipelineautomationgithub1736832181462.config.Context
