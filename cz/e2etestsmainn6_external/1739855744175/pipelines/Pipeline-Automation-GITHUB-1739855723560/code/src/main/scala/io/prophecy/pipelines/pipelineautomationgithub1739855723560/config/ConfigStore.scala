package io.prophecy.pipelines.pipelineautomationgithub1739855723560.config

import io.prophecy.pipelines.pipelineautomationgithub1739855723560.config.Context
