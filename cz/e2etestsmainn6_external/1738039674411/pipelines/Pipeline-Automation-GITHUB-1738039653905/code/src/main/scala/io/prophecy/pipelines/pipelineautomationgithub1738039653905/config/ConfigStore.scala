package io.prophecy.pipelines.pipelineautomationgithub1738039653905.config

import io.prophecy.pipelines.pipelineautomationgithub1738039653905.config.Context
