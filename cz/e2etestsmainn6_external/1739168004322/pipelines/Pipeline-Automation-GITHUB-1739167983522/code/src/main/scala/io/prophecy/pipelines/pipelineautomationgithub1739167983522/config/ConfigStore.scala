package io.prophecy.pipelines.pipelineautomationgithub1739167983522.config

import io.prophecy.pipelines.pipelineautomationgithub1739167983522.config.Context
