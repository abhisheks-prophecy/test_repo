package io.prophecy.pipelines.workflowautomationgithub1737694549233.config

import io.prophecy.pipelines.workflowautomationgithub1737694549233.config.Context
