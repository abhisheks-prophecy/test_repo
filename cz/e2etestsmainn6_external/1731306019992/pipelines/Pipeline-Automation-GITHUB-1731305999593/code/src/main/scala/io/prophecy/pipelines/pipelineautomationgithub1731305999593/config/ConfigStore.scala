package io.prophecy.pipelines.pipelineautomationgithub1731305999593.config

import io.prophecy.pipelines.pipelineautomationgithub1731305999593.config.Context
