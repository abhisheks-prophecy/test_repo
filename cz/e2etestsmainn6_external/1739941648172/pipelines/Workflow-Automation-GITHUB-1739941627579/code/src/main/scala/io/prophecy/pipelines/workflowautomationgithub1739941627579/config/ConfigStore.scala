package io.prophecy.pipelines.workflowautomationgithub1739941627579.config

import io.prophecy.pipelines.workflowautomationgithub1739941627579.config.Context
