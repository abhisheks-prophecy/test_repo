package io.prophecy.pipelines.pipelineautomationgithub1739941627579.config

import io.prophecy.pipelines.pipelineautomationgithub1739941627579.config.Context
