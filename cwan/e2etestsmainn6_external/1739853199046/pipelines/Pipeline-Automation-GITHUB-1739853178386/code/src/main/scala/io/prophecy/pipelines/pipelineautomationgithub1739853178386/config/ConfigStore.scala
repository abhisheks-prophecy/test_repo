package io.prophecy.pipelines.pipelineautomationgithub1739853178386.config

import io.prophecy.pipelines.pipelineautomationgithub1739853178386.config.Context
