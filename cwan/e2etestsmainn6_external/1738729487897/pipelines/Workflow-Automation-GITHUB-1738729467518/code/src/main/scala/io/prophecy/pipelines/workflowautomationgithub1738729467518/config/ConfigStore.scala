package io.prophecy.pipelines.workflowautomationgithub1738729467518.config

import io.prophecy.pipelines.workflowautomationgithub1738729467518.config.Context
