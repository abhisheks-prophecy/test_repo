package io.prophecy.pipelines.workflowautomationgithub1739506398001.config

import io.prophecy.pipelines.workflowautomationgithub1739506398001.config.Context
