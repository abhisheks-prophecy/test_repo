package io.prophecy.pipelines.pipelineautomationgithub1733453629238.config

import io.prophecy.pipelines.pipelineautomationgithub1733453629238.config.Context
