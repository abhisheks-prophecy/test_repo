package io.prophecy.pipelines.workflowautomationgithub1740026357990.config

import io.prophecy.pipelines.workflowautomationgithub1740026357990.config.Context
