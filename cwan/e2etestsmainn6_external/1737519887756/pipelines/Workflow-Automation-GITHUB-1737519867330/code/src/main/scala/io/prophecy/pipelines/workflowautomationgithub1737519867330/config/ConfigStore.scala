package io.prophecy.pipelines.workflowautomationgithub1737519867330.config

import io.prophecy.pipelines.workflowautomationgithub1737519867330.config.Context
