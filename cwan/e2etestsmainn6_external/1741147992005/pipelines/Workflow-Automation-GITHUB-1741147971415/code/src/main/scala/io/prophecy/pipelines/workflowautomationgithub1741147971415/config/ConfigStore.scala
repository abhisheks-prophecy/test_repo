package io.prophecy.pipelines.workflowautomationgithub1741147971415.config

import io.prophecy.pipelines.workflowautomationgithub1741147971415.config.Context
