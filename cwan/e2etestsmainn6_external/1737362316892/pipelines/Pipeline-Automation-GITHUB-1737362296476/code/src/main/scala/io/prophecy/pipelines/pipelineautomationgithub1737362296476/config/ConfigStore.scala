package io.prophecy.pipelines.pipelineautomationgithub1737362296476.config

import io.prophecy.pipelines.pipelineautomationgithub1737362296476.config.Context
