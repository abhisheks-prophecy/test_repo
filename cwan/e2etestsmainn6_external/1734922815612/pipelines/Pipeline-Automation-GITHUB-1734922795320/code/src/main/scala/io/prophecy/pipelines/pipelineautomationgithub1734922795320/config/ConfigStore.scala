package io.prophecy.pipelines.pipelineautomationgithub1734922795320.config

import io.prophecy.pipelines.pipelineautomationgithub1734922795320.config.Context
