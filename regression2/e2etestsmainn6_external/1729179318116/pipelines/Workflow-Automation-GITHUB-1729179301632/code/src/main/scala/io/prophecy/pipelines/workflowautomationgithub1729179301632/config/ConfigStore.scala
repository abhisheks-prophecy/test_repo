package io.prophecy.pipelines.workflowautomationgithub1729179301632.config

import io.prophecy.pipelines.workflowautomationgithub1729179301632.config.Context
