package io.prophecy.pipelines.pipelineautomationgithub1732798472086.config

import io.prophecy.pipelines.pipelineautomationgithub1732798472086.config.Context
