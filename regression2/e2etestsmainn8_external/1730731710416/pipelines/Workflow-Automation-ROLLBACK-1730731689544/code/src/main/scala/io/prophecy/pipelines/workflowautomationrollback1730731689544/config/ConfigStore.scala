package io.prophecy.pipelines.workflowautomationrollback1730731689544.config

import io.prophecy.pipelines.workflowautomationrollback1730731689544.config.Context
