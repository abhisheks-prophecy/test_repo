...
def main():
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri", "13986/pipelines/Automated-Github-UpdateToken-Pipeline")
    MetricsCollector.start(spark = spark, pipelineId = "13986/pipelines/Automated-Github-UpdateToken-Pipeline")
    pipeline(spark)
