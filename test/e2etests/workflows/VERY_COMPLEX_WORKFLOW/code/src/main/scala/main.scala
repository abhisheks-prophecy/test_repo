...
object Main {
  ...
  def apply(spark: SparkSession): Unit = {
    ...
    val df_OrderBy_1    = OrderBy_1(spark,    df_Join_1)
    Target_1(spark, df_OrderBy_1)
    val df_Source_4           = Source_4(spark)
    val df_Filter_1_1_1_1_1   = Filter_1_1_1_1_1(spark,   df_Source_4)
    val df_Filter_1_1_1_1_1_1 = Filter_1_1_1_1_1_1(spark, df_Source_4)
    val df_Join_5             = Join_5(spark,             df_Filter_1_1_1_1_1_1, df_Filter_1_1_1_1_1)
    ...
    val df_SetOperation_1 = SetOperation_1(spark, df_Source_1, df_Filter_1_1)
    Target_1_1_1(spark, df_Join_3)
    val df_SchemaTransform_1 = SchemaTransform_1(spark, df_Join_3)
