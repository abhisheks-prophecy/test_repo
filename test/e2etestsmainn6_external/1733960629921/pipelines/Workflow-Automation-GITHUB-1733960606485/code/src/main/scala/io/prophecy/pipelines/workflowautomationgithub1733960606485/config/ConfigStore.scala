package io.prophecy.pipelines.workflowautomationgithub1733960606485.config

import io.prophecy.pipelines.workflowautomationgithub1733960606485.config.Context
