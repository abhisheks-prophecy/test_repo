package io.prophecy.pipelines.pipelineautomationgithub1735548981032.config

import io.prophecy.pipelines.pipelineautomationgithub1735548981032.config.Context
