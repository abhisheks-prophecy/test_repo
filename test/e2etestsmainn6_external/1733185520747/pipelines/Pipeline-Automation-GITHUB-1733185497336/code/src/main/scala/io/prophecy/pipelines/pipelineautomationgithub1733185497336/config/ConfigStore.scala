package io.prophecy.pipelines.pipelineautomationgithub1733185497336.config

import io.prophecy.pipelines.pipelineautomationgithub1733185497336.config.Context
