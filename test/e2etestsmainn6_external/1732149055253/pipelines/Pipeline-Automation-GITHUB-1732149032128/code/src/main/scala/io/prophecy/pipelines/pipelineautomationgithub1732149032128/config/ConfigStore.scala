package io.prophecy.pipelines.pipelineautomationgithub1732149032128.config

import io.prophecy.pipelines.pipelineautomationgithub1732149032128.config.Context
