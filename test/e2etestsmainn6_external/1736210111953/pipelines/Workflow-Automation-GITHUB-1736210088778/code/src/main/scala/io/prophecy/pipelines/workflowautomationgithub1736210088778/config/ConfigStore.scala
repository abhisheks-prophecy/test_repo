package io.prophecy.pipelines.workflowautomationgithub1736210088778.config

import io.prophecy.pipelines.workflowautomationgithub1736210088778.config.Context
