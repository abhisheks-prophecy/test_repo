package io.prophecy.pipelines.workflowautomationgithub1725923931503.config

import io.prophecy.pipelines.workflowautomationgithub1725923931503.config.Context
