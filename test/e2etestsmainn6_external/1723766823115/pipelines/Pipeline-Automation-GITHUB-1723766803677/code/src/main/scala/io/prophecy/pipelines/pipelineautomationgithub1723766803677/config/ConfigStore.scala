package io.prophecy.pipelines.pipelineautomationgithub1723766803677.config

import io.prophecy.pipelines.pipelineautomationgithub1723766803677.config.Context
