package io.prophecy.pipelines.workflowautomationgithub1723421948909.config

import io.prophecy.pipelines.workflowautomationgithub1723421948909.config.Context
