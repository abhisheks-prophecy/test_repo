package io.prophecy.pipelines.pipelineautomationgithub1730941982411.config

import io.prophecy.pipelines.pipelineautomationgithub1730941982411.config.Context
