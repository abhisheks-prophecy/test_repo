package io.prophecy.pipelines.workflowautomationgithub1715736771200.config

import io.prophecy.pipelines.workflowautomationgithub1715736771200.config.Context
