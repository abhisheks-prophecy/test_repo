package io.prophecy.pipelines.pipelineautomationgithub1715736771200.config

import io.prophecy.pipelines.pipelineautomationgithub1715736771200.config.Context
