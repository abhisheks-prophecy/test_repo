package io.prophecy.pipelines.workflowautomationgithub1730101486150.config

import io.prophecy.pipelines.workflowautomationgithub1730101486150.config.Context
