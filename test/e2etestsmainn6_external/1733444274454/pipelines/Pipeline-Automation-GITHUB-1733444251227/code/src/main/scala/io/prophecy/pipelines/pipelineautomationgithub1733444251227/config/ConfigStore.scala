package io.prophecy.pipelines.pipelineautomationgithub1733444251227.config

import io.prophecy.pipelines.pipelineautomationgithub1733444251227.config.Context
