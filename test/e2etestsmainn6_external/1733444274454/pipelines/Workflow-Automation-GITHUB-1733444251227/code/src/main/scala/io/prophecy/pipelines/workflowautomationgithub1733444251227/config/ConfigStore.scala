package io.prophecy.pipelines.workflowautomationgithub1733444251227.config

import io.prophecy.pipelines.workflowautomationgithub1733444251227.config.Context
