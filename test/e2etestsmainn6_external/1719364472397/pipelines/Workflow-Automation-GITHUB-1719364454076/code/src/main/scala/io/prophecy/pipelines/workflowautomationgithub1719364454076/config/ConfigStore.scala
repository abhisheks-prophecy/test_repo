package io.prophecy.pipelines.workflowautomationgithub1719364454076.config

import io.prophecy.pipelines.workflowautomationgithub1719364454076.config.Context
