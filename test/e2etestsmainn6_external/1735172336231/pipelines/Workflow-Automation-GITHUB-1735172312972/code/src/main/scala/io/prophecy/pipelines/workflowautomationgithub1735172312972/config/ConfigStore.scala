package io.prophecy.pipelines.workflowautomationgithub1735172312972.config

import io.prophecy.pipelines.workflowautomationgithub1735172312972.config.Context
