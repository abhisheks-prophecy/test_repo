package io.prophecy.pipelines.workflowautomationgithub1737593026052.config

import io.prophecy.pipelines.workflowautomationgithub1737593026052.config.Context
