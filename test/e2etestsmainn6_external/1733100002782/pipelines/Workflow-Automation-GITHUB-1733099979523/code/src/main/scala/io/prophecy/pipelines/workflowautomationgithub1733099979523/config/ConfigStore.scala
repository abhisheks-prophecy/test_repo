package io.prophecy.pipelines.workflowautomationgithub1733099979523.config

import io.prophecy.pipelines.workflowautomationgithub1733099979523.config.Context
