package io.prophecy.pipelines.workflowautomationgithub1716512624834.config

import io.prophecy.pipelines.workflowautomationgithub1716512624834.config.Context
