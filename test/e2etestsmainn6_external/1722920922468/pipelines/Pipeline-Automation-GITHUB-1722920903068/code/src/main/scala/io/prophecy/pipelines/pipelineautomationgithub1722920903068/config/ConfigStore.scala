package io.prophecy.pipelines.pipelineautomationgithub1722920903068.config

import io.prophecy.pipelines.pipelineautomationgithub1722920903068.config.Context
