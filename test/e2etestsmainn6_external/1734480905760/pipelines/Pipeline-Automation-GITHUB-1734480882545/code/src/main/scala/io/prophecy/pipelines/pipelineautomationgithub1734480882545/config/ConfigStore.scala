package io.prophecy.pipelines.pipelineautomationgithub1734480882545.config

import io.prophecy.pipelines.pipelineautomationgithub1734480882545.config.Context
