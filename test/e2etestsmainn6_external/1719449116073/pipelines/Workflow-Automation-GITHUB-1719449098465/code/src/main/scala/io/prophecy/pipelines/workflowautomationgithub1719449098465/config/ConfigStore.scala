package io.prophecy.pipelines.workflowautomationgithub1719449098465.config

import io.prophecy.pipelines.workflowautomationgithub1719449098465.config.Context
