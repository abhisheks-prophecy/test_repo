package io.prophecy.pipelines.workflowautomationgithub1733271755609.config

import io.prophecy.pipelines.workflowautomationgithub1733271755609.config.Context
