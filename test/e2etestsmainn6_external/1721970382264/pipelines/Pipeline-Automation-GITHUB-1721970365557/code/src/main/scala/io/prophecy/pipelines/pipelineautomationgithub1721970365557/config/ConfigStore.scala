package io.prophecy.pipelines.pipelineautomationgithub1721970365557.config

import io.prophecy.pipelines.pipelineautomationgithub1721970365557.config.Context
