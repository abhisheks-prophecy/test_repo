package io.prophecy.pipelines.workflowautomationgithub1725443803040.config

import io.prophecy.pipelines.workflowautomationgithub1725443803040.config.Context
