package io.prophecy.pipelines.pipelineautomationgithub1730249511555.config

import io.prophecy.pipelines.pipelineautomationgithub1730249511555.config.Context
