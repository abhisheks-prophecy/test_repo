package io.prophecy.pipelines.pipelineautomationgithub1727914565866.config

import io.prophecy.pipelines.pipelineautomationgithub1727914565866.config.Context
