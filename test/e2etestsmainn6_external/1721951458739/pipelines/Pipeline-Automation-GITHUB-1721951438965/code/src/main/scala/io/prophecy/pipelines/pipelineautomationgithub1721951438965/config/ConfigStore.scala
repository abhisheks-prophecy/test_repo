package io.prophecy.pipelines.pipelineautomationgithub1721951438965.config

import io.prophecy.pipelines.pipelineautomationgithub1721951438965.config.Context
