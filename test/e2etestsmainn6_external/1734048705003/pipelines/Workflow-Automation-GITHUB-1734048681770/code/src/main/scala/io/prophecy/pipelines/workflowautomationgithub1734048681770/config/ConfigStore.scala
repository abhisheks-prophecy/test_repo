package io.prophecy.pipelines.workflowautomationgithub1734048681770.config

import io.prophecy.pipelines.workflowautomationgithub1734048681770.config.Context
