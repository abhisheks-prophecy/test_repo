package io.prophecy.pipelines.pipelineautomationgithub1736400195017.config

import io.prophecy.pipelines.pipelineautomationgithub1736400195017.config.Context
