...
class Reformat_4Test extends FunSuite with DataFrameSuiteBase {
  ...
  test("Unit Test 0") {
    ...
    val dfIn = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_4/in/schema.json",
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_4/in/data/unit_test_0.json",
      "in"
    )
    val dfOut = createDfFromResourceFiles(
      spark,
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_4/out/schema.json",
      "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Reformat_4/out/data/unit_test_0.json",
      "out"
    )

    val dfOutComputed =
      io.prophecy.pipelines.scalainsideprojectdatasetsonly.graph
        .Reformat_4(context, dfIn)
    val res = assertDFEquals(dfOut.select("c_short", "c_int"),
  ...
  override def beforeAll() = {
    ...
    val dfProphecy_pipelines_scalainsideprojectdatasetsonly_graph_Lookup_1 =
      createDfFromResourceFiles(
        spark,
        "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Lookup_1/schema.json",
        "/data/io/prophecy/pipelines/scalainsideprojectdatasetsonly/graph/Lookup_1/data.json",
        port = "in"
      )
