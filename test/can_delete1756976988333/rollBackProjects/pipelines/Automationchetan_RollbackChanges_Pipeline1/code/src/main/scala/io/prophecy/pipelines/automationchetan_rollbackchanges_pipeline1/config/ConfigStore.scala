...
import io.prophecy.pipelines.automationchetan_rollbackchanges_pipeline1.config.Context
...
object ConfigurationFactoryImpl extends ConfigurationFactory[Config] {
  ...
  def getConfig(args: Array[String]) =
    fromCLI(args,
            "",
            "io/prophecy/pipelines/automationchetan_rollbackchanges_pipeline1"
    )
