package io.prophecy.pipelines.workflowautomationgithub1726112442865.config

import io.prophecy.pipelines.workflowautomationgithub1726112442865.config.Context
