package io.prophecy.pipelines.pipelineautomationgithub1723592453330.config

import io.prophecy.pipelines.pipelineautomationgithub1723592453330.config.Context
