package io.prophecy.pipelines.pipelineautomationgithub1724880223018.config

import io.prophecy.pipelines.pipelineautomationgithub1724880223018.config.Context
