package io.prophecy.pipelines.pipelineautomationgithub1727192683522.config

import io.prophecy.pipelines.pipelineautomationgithub1727192683522.config.Context
