package io.prophecy.pipelines.pipelineautomationgithub1725982020448.config

import io.prophecy.pipelines.pipelineautomationgithub1725982020448.config.Context
