package io.prophecy.pipelines.pipelineautomationgithub1737198332894.config

import io.prophecy.pipelines.pipelineautomationgithub1737198332894.config.Context
