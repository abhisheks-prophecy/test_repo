package io.prophecy.pipelines.workflowautomationgithub1738658478676.config

import io.prophecy.pipelines.workflowautomationgithub1738658478676.config.Context
