package io.prophecy.pipelines.pipelineautomationgithub1716182267719.config

import io.prophecy.pipelines.pipelineautomationgithub1716182267719.config.Context
