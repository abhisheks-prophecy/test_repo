package io.prophecy.pipelines.pipelineautomationgithub1735793587291.config

import io.prophecy.pipelines.pipelineautomationgithub1735793587291.config.Context
