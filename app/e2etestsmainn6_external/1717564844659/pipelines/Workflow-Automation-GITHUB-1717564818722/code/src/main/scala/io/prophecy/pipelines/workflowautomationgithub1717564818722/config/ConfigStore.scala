package io.prophecy.pipelines.workflowautomationgithub1717564818722.config

import io.prophecy.pipelines.workflowautomationgithub1717564818722.config.Context
