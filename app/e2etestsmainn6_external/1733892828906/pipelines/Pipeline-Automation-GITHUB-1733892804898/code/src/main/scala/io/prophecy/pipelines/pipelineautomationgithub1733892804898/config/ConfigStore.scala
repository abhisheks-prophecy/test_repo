package io.prophecy.pipelines.pipelineautomationgithub1733892804898.config

import io.prophecy.pipelines.pipelineautomationgithub1733892804898.config.Context
