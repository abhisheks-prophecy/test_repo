package io.prophecy.pipelines.pipelineautomationgithub1735792658106.config

import io.prophecy.pipelines.pipelineautomationgithub1735792658106.config.Context
