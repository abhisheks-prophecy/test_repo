package io.prophecy.pipelines.pipelineautomationgithub1735189197276.config

import io.prophecy.pipelines.pipelineautomationgithub1735189197276.config.Context
