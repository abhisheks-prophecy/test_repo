package io.prophecy.pipelines.pipelineautomationgithub1740977699782.config

import io.prophecy.pipelines.pipelineautomationgithub1740977699782.config.Context
