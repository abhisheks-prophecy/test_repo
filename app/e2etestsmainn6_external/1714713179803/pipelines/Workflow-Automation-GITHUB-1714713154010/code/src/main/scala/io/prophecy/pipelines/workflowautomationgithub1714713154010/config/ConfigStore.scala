package io.prophecy.pipelines.workflowautomationgithub1714713154010.config

import io.prophecy.pipelines.workflowautomationgithub1714713154010.config.Context
