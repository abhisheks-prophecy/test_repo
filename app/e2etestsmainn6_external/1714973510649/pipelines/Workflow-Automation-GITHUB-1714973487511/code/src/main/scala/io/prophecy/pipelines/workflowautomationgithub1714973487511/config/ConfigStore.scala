package io.prophecy.pipelines.workflowautomationgithub1714973487511.config

import io.prophecy.pipelines.workflowautomationgithub1714973487511.config.Context
