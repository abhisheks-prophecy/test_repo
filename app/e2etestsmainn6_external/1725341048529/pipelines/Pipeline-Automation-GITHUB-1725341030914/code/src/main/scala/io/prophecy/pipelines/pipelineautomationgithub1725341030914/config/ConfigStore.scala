package io.prophecy.pipelines.pipelineautomationgithub1725341030914.config

import io.prophecy.pipelines.pipelineautomationgithub1725341030914.config.Context
