package io.prophecy.pipelines.pipelineautomationgithub1736830147271.config

import io.prophecy.pipelines.pipelineautomationgithub1736830147271.config.Context
