package io.prophecy.pipelines.workflowautomationgithub1714489815918.config

import io.prophecy.pipelines.workflowautomationgithub1714489815918.config.Context
