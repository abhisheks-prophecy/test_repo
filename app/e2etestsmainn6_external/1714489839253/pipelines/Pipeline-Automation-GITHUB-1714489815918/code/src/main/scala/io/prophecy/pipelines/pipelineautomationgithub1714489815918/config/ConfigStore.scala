package io.prophecy.pipelines.pipelineautomationgithub1714489815918.config

import io.prophecy.pipelines.pipelineautomationgithub1714489815918.config.Context
