package io.prophecy.pipelines.workflowautomationgithub1720506731257.config

import io.prophecy.pipelines.workflowautomationgithub1720506731257.config.Context
