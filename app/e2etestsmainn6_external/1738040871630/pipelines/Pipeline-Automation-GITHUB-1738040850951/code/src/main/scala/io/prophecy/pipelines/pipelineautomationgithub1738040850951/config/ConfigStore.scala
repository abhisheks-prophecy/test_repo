package io.prophecy.pipelines.pipelineautomationgithub1738040850951.config

import io.prophecy.pipelines.pipelineautomationgithub1738040850951.config.Context
