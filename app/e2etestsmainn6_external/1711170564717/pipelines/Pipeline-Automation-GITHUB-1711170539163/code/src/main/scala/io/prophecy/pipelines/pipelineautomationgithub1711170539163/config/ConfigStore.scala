package io.prophecy.pipelines.pipelineautomationgithub1711170539163.config

import io.prophecy.pipelines.pipelineautomationgithub1711170539163.config.Context
