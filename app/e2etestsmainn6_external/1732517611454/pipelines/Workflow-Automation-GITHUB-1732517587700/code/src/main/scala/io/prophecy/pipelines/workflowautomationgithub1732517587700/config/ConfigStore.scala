package io.prophecy.pipelines.workflowautomationgithub1732517587700.config

import io.prophecy.pipelines.workflowautomationgithub1732517587700.config.Context
