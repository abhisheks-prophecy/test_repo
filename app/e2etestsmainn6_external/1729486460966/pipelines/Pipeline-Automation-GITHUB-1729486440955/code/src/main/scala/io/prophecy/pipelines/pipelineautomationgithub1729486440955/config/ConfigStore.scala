package io.prophecy.pipelines.pipelineautomationgithub1729486440955.config

import io.prophecy.pipelines.pipelineautomationgithub1729486440955.config.Context
