package io.prophecy.pipelines.pipelineautomationgithub1718861022135.config

import io.prophecy.pipelines.pipelineautomationgithub1718861022135.config.Context
