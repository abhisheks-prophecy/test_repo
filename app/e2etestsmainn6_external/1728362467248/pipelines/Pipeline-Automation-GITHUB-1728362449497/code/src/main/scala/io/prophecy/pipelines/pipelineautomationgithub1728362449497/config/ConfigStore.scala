package io.prophecy.pipelines.pipelineautomationgithub1728362449497.config

import io.prophecy.pipelines.pipelineautomationgithub1728362449497.config.Context
