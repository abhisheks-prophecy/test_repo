package io.prophecy.pipelines.pipelineautomationgithub1724055122130.config

import io.prophecy.pipelines.pipelineautomationgithub1724055122130.config.Context
