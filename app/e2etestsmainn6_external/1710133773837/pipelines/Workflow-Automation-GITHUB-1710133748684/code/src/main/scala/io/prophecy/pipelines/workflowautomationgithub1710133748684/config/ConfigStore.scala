package io.prophecy.pipelines.workflowautomationgithub1710133748684.config

import io.prophecy.pipelines.workflowautomationgithub1710133748684.config.Context
