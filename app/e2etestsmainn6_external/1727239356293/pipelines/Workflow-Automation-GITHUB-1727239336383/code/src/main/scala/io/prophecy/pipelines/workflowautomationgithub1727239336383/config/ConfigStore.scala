package io.prophecy.pipelines.workflowautomationgithub1727239336383.config

import io.prophecy.pipelines.workflowautomationgithub1727239336383.config.Context
