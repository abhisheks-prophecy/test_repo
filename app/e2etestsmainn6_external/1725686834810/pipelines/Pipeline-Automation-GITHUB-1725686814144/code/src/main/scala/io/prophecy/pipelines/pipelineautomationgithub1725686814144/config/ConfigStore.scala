package io.prophecy.pipelines.pipelineautomationgithub1725686814144.config

import io.prophecy.pipelines.pipelineautomationgithub1725686814144.config.Context
