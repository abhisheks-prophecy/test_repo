package io.prophecy.pipelines.workflowautomationgithub1716293184006.config

import io.prophecy.pipelines.workflowautomationgithub1716293184006.config.Context
