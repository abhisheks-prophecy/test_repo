package io.prophecy.pipelines.pipelineautomationgithub1718256075152.config

import io.prophecy.pipelines.pipelineautomationgithub1718256075152.config.Context
