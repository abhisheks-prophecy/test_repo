package io.prophecy.pipelines.workflowautomationgithub1720768341481.config

import io.prophecy.pipelines.workflowautomationgithub1720768341481.config.Context
