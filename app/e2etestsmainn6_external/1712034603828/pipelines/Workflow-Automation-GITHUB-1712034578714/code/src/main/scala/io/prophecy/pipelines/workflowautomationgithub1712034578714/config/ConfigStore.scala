package io.prophecy.pipelines.workflowautomationgithub1712034578714.config

import io.prophecy.pipelines.workflowautomationgithub1712034578714.config.Context
