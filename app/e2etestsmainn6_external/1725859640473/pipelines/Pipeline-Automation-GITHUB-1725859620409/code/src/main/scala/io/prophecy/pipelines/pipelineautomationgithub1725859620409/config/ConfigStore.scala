package io.prophecy.pipelines.pipelineautomationgithub1725859620409.config

import io.prophecy.pipelines.pipelineautomationgithub1725859620409.config.Context
