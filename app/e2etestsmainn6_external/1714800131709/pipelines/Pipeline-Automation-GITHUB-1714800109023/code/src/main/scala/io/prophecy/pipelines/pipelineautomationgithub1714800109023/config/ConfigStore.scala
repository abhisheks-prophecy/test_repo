package io.prophecy.pipelines.pipelineautomationgithub1714800109023.config

import io.prophecy.pipelines.pipelineautomationgithub1714800109023.config.Context
