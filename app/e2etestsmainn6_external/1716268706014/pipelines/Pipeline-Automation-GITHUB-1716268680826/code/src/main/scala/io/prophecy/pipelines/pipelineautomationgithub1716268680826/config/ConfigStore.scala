package io.prophecy.pipelines.pipelineautomationgithub1716268680826.config

import io.prophecy.pipelines.pipelineautomationgithub1716268680826.config.Context
