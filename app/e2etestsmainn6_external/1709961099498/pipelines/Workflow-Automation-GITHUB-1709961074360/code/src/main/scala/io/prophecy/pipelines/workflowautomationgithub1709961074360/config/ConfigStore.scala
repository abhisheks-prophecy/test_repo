package io.prophecy.pipelines.workflowautomationgithub1709961074360.config

import io.prophecy.pipelines.workflowautomationgithub1709961074360.config.Context
