package io.prophecy.pipelines.pipelineautomationgithub1716701098883.config

import io.prophecy.pipelines.pipelineautomationgithub1716701098883.config.Context
