package io.prophecy.pipelines.pipelineautomationgithub1715772882647.config

import io.prophecy.pipelines.pipelineautomationgithub1715772882647.config.Context
