package io.prophecy.pipelines.pipelineautomationgithub1718515065978.config

import io.prophecy.pipelines.pipelineautomationgithub1718515065978.config.Context
