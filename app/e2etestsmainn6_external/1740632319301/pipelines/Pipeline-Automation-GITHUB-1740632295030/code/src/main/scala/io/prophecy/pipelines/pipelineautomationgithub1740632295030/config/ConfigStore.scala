package io.prophecy.pipelines.pipelineautomationgithub1740632295030.config

import io.prophecy.pipelines.pipelineautomationgithub1740632295030.config.Context
