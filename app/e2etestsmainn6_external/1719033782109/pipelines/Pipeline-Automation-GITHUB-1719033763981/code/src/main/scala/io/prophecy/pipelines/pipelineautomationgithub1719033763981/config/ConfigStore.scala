package io.prophecy.pipelines.pipelineautomationgithub1719033763981.config

import io.prophecy.pipelines.pipelineautomationgithub1719033763981.config.Context
