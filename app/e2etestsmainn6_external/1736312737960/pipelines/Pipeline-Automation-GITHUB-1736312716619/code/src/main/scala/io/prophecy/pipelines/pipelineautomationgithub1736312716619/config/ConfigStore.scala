package io.prophecy.pipelines.pipelineautomationgithub1736312716619.config

import io.prophecy.pipelines.pipelineautomationgithub1736312716619.config.Context
