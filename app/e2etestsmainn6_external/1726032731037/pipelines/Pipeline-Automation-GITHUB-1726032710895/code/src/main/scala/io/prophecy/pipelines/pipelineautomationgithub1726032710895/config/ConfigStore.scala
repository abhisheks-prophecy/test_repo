package io.prophecy.pipelines.pipelineautomationgithub1726032710895.config

import io.prophecy.pipelines.pipelineautomationgithub1726032710895.config.Context
