package io.prophecy.pipelines.pipelineautomationgithub1728448971722.config

import io.prophecy.pipelines.pipelineautomationgithub1728448971722.config.Context
