package io.prophecy.pipelines.pipelineautomationgithub1722230509025.config

import io.prophecy.pipelines.pipelineautomationgithub1722230509025.config.Context
