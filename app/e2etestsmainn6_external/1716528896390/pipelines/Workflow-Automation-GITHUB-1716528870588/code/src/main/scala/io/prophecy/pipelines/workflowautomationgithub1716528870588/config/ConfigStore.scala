package io.prophecy.pipelines.workflowautomationgithub1716528870588.config

import io.prophecy.pipelines.workflowautomationgithub1716528870588.config.Context
