package io.prophecy.pipelines.workflowautomationgithub1707973554324.config

import io.prophecy.pipelines.workflowautomationgithub1707973554324.config.Context
