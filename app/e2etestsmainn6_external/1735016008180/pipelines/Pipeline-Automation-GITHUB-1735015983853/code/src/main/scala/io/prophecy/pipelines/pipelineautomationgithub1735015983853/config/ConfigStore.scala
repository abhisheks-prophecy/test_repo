package io.prophecy.pipelines.pipelineautomationgithub1735015983853.config

import io.prophecy.pipelines.pipelineautomationgithub1735015983853.config.Context
