package io.prophecy.pipelines.workflowautomationgithub1734669653392.config

import io.prophecy.pipelines.workflowautomationgithub1734669653392.config.Context
