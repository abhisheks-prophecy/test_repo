package io.prophecy.pipelines.workflowautomationgithub1725945965040.config

import io.prophecy.pipelines.workflowautomationgithub1725945965040.config.Context
