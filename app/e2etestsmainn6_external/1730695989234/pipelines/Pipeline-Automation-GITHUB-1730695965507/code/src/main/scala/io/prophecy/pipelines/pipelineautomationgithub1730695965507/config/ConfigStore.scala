package io.prophecy.pipelines.pipelineautomationgithub1730695965507.config

import io.prophecy.pipelines.pipelineautomationgithub1730695965507.config.Context
