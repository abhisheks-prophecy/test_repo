package io.prophecy.pipelines.pipelineautomationgithub1716615030064.config

import io.prophecy.pipelines.pipelineautomationgithub1716615030064.config.Context
