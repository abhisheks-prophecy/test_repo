package io.prophecy.pipelines.workflowautomationgithub1734065017942.config

import io.prophecy.pipelines.workflowautomationgithub1734065017942.config.Context
