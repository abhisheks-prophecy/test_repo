package io.prophecy.pipelines.pipelineautomationgithub1734065017942.config

import io.prophecy.pipelines.pipelineautomationgithub1734065017942.config.Context
