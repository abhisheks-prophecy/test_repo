package io.prophecy.pipelines.workflowautomationgithub1720243614631.config

import io.prophecy.pipelines.workflowautomationgithub1720243614631.config.Context
