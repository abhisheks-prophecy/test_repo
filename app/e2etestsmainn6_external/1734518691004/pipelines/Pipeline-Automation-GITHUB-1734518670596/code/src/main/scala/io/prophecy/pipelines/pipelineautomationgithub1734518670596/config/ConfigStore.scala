package io.prophecy.pipelines.pipelineautomationgithub1734518670596.config

import io.prophecy.pipelines.pipelineautomationgithub1734518670596.config.Context
