package io.prophecy.pipelines.workflowautomationgithub1722317043919.config

import io.prophecy.pipelines.workflowautomationgithub1722317043919.config.Context
