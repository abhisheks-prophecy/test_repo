package io.prophecy.pipelines.workflowautomationgithub1712056543945.config

import io.prophecy.pipelines.workflowautomationgithub1712056543945.config.Context
