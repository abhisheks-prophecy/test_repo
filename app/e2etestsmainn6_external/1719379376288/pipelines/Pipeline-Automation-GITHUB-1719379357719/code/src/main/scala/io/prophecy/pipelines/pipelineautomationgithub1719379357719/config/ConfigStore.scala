package io.prophecy.pipelines.pipelineautomationgithub1719379357719.config

import io.prophecy.pipelines.pipelineautomationgithub1719379357719.config.Context
