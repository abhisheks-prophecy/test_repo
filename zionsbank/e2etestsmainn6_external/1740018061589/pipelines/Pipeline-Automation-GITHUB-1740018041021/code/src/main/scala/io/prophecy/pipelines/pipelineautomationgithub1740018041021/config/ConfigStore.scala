package io.prophecy.pipelines.pipelineautomationgithub1740018041021.config

import io.prophecy.pipelines.pipelineautomationgithub1740018041021.config.Context
