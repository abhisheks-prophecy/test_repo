package io.prophecy.pipelines.pipelineautomationgithub1737079020054.config

import io.prophecy.pipelines.pipelineautomationgithub1737079020054.config.Context
