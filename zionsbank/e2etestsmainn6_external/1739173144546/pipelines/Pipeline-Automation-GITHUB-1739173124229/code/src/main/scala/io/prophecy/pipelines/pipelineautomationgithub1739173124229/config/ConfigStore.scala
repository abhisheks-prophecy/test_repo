package io.prophecy.pipelines.pipelineautomationgithub1739173124229.config

import io.prophecy.pipelines.pipelineautomationgithub1739173124229.config.Context
