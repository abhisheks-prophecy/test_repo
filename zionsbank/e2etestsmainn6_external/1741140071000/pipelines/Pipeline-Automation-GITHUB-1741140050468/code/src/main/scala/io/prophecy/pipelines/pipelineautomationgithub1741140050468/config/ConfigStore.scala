package io.prophecy.pipelines.pipelineautomationgithub1741140050468.config

import io.prophecy.pipelines.pipelineautomationgithub1741140050468.config.Context
