package io.prophecy.pipelines.pipelineautomationgithub1739411618551.config

import io.prophecy.pipelines.pipelineautomationgithub1739411618551.config.Context
