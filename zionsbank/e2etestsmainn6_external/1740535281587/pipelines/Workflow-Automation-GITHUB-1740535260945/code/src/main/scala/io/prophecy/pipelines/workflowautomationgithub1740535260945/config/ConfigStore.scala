package io.prophecy.pipelines.workflowautomationgithub1740535260945.config

import io.prophecy.pipelines.workflowautomationgithub1740535260945.config.Context
