package io.prophecy.pipelines.pipelineautomationgithub1737597388412.config

import io.prophecy.pipelines.pipelineautomationgithub1737597388412.config.Context
