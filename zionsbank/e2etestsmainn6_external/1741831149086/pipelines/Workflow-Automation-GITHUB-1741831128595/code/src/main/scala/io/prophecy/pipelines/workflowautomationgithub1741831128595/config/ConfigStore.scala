package io.prophecy.pipelines.workflowautomationgithub1741831128595.config

import io.prophecy.pipelines.workflowautomationgithub1741831128595.config.Context
