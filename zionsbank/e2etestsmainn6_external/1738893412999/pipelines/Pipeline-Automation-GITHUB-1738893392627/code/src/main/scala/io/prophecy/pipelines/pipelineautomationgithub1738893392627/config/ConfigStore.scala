package io.prophecy.pipelines.pipelineautomationgithub1738893392627.config

import io.prophecy.pipelines.pipelineautomationgithub1738893392627.config.Context
