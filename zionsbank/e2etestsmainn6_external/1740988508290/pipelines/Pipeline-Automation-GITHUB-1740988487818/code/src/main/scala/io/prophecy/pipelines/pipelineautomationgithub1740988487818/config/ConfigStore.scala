package io.prophecy.pipelines.pipelineautomationgithub1740988487818.config

import io.prophecy.pipelines.pipelineautomationgithub1740988487818.config.Context
