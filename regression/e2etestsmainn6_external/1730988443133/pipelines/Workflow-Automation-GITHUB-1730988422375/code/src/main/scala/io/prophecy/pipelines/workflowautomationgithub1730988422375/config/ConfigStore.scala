package io.prophecy.pipelines.workflowautomationgithub1730988422375.config

import io.prophecy.pipelines.workflowautomationgithub1730988422375.config.Context
