package io.prophecy.pipelines.pipelineautomationgithub1736311027427.config

import io.prophecy.pipelines.pipelineautomationgithub1736311027427.config.Context
