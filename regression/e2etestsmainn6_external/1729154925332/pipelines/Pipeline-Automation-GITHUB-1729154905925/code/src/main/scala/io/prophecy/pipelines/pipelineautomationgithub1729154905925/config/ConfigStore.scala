package io.prophecy.pipelines.pipelineautomationgithub1729154905925.config

import io.prophecy.pipelines.pipelineautomationgithub1729154905925.config.Context
