package io.prophecy.pipelines.workflowautomationgithub1731224770367.config

import io.prophecy.pipelines.workflowautomationgithub1731224770367.config.Context
