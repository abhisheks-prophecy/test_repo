package io.prophecy.pipelines.pipelineautomationgithub1738239843329.config

import io.prophecy.pipelines.pipelineautomationgithub1738239843329.config.Context
